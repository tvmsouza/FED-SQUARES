...
class Server:
    ...
    def test_model(self, clients_to_test, set_to_use='test'):
        ...
        for client in clients_to_test:
            ...
            if(set_to_use ==  'train'):
                for i in range(client.num_train_samples):
                    metrics[client.id+'_sample_'+str(i)] = c_metrics
            if(set_to_use ==  'test'):
                for i in range(client.num_test_samples):
                    metrics[client.id+'_sample_'+str(i)] = c_metrics
    ...
    def get_clients_info(self, clients):
        ...
        num_samples = {c.id: [c.num_samples,c.num_train_samples,c.num_test_samples] for c in clients}
