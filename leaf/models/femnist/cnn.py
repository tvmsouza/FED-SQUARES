...
class ClientModel(Model):
    ...
    def create_model(self):
        ...
        dense = tf.layers.dense(inputs=pool2_flat, units=490, activation=tf.nn.relu)
        ...
        return features, labels, train_op, eval_metric_ops, loss, predictions["probabilities"], predictions["classes"]
